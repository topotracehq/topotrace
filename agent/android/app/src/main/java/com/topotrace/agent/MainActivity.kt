...
import com.topotrace.agent.databinding.ActivityMainBinding
...
/**
 * Single-screen setup UI: enter the TopoTrace server URL, a host name, and
        ...
        lifecycleScope.launch {
            try {
                ...
                withContext(Dispatchers.IO) {
                    TopoTraceClient.postMobileReport(
                        baseUrl = serverUrl,
                        host = hostName,
                        platform = "android",
                        token = token,
