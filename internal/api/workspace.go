...
func (s *Server) handleAbout(w http.ResponseWriter, r *http.Request) {
	...
	s.writeJSON(w, 200, map[string]any{"product": "Muster", "version": releaseVersion, "revision": revision, "company": "McGinnis Technologies, LLC", "copyright": "© 2022–2026 McGinnis Technologies, LLC.", "support": "Contact the administrator who manages your Muster deployment. Include this version and a description of the issue; do not include passwords or API tokens."})
}
