...
window.TopoTraceWorkspace = function ({api,el,app,downloadWithToken}) {
  ...
  async function notificationPreferencesCard(){
    ...
    const notify=el("details",{class:"fact-card settings-card"},el("summary",{class:"settings-summary"},el("span",{class:"settings-summary-copy"},el("strong",{text:"Delivery schedule"}),el("small",{text:"Quiet hours, digests, and escalation timing."})),el("span",{class:"settings-summary-action",text:"Review settings"})),body);
