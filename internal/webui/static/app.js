...
(() => {
  ...
  async function showSettings() {
    ...
    ], authLDAPEditor(s), "Connect your organization directory and map groups to roles.");
    ...
    ], authSAMLEditor(s), "Configure identity-provider sign-in for your organization.");
    ...
    ], mfaEditor(s), "Require authenticator codes for selected roles or everyone.");
    ...
    const overview = el("div", { class: "manage-overview", "aria-label": "Settings categories" },
      el("div", { class: "manage-tile" }, el("span", { text: "Access" }), el("strong", { text: "Sign-in & security" }), el("small", { text: "OAuth, SSO, MFA, and roles" })),
